...
user1.photos.attach(io: file1, filename: "nes.png", content_type: "image/png")
user1.save
...
user2.photos.attach([
  ...
  {io: file6, filename: 'file3.png', content_type: 'image/png'},
])
user2.save

file3 = URI.open("https://avatars.githubusercontent.com/u/66433133?v=4")
file7 = URI.open("https://avatars.githubusercontent.com/u/107856581?v=4")
...
user4.photos.attach(io: file4, filename: "alberto.png", content_type: "image/png")
user4.save
...
user5.photos.attach(io: file5, filename: "maria.png", content_type: "image/png")
user5.save
